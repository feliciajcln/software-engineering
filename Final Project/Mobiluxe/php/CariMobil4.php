<?php
  ...
  $servername = "localhost:3306";
    ...
    $user = $row['UserId'];
    $sql2 = "SELECT * FROM `user` WHERE UserId = '$user'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      if (isset($_POST['submit'])) {
          $id = $_SESSION["UserId"];
          $sql3 = "INSERT INTO `transaction`(`id_tenant`, `id_customer`, `id_mobil`) VALUES ('$user', '$id', '$carid')";
...
<html lang="en">
  ...
  <body>
    <div class="center" style="margin-bottom: 0px">
      ...
      <p style="margin-top: 30px">Alamat<span style="margin-left: 10px">: <br><?php echo $row2['UserAddres'];?></span></p>
      <p>Kontak<span style="margin-left: 33px">: <?php echo $row2['UserPhone'];?></span></p>
    ...
    <form class="form" id="EditData" method="POST">
      <label for='submit'>
        <h3 style="margin-top: 10px; margin-bottom: 10px">Order</h3>
      </label>
      <input style="display: none" type="submit" id="submit" name="submit" value="'.$lol.'">
    </form>
