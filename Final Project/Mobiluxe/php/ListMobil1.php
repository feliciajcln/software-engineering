<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['submit'])) {
            ...
            header("location: /Mobiluxe/php/ListMobil2.php");
        }else if (isset($_POST['submit2'])) {
            $_SESSION["CarId"] = $_POST['submit2'];
            
            header("location: /Mobiluxe/php/ListMobil3.php");
        }
      }
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="middle-box">
      ...
      <div class="ot-box">
        <button onclick="addcar()" class="button">+</button>
      </div>
    </div>
